...
$user_record = DB::connection('mysql1')->select('SELECT email FROM password_resets WHERE token = "'.$token.'" ORDER BY created_at DESC LIMIT 1');
...
<!--   <section>
 ...
 <div class="container-fluid">
  <div class="rows">
    ...
    <form method="GET" id="login" action="/reset-password-change" >
      @csrf
       ...
       <div class="card" style="border-radius: 25px;">
        ...
        <div class="col-md-12 col-sm-12">
            <div class="form-group">
             ...
             <input type="password" name="password" id="password" class="form-control" placeholder="New Password" value="{{ old('password') }}" required>
        ...
        <div class="col-md-12 col-sm-12">
            <div class="form-group">
             ...
             <input type="password" name="password_confirmation" id="confirmed" class="form-control" placeholder="Confirm Password" value="{{ old('confirmed') }}" required>
             <span toggle="#confirmed" class="eye-icon"></span>
             <p class="help-block text-danger">
              @error('confirmed')
              {{$message}}
              @enderror
