...
<head>
<meta charset="utf-8">
<title>Carshire - Car Repair Service HTML5 Template | Blog Detail</title>
<!-- Stylesheets -->
            ...
            <div class="row clearfix">
                ...
                <section class="left-content col-lg-9 col-md-8 col-sm-7 col-xs-12">
                    ...
                    <div class="about-author wow fadeIn" data-wow-delay="0ms" data-wow-duration="1500ms">
                        ...
                        <div class="author-info"><strong>Jonathan Doe</strong> /  24 Blogposts / Entrepreneur / works for Company Inc.</div>
                    ...
                    <div class="comments-area">
                    	<div class="sec-title"><h3 class="skew-lines">Comments</h3></div>
                        <div class="comment-box">
                        	<div class="comment wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                                ...
                                <a href="#" class="theme-btn dark-btn reply-btn"><span class="fa fa-arrows-v"></span> Reply</a>
                            </div>
