        ...
        <div class="card card-primary card-outline card-outline-tabs">
            ...
            <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
              <li class="nav-item">
                <a class="nav-link active" id="custom-tabs-four-home-tab" data-toggle="pill" href="#custom-tabs-four-home" role="tab" aria-controls="custom-tabs-four-home" aria-selected="true">
                  <i class="fa fa-list">&nbsp;&nbsp;</i>Team Listing
                </a>
              </li>
              <li class="nav-item">
            ...
            <div class="tab-content" id="custom-tabs-four-tabContent">
              <div class="tab-pane fade show active" id="custom-tabs-four-home" role="tabpanel" aria-labelledby="custom-tabs-four-home-tab">
                ...
                @foreach ($team as $data)
                 <tr>
                  <td>{{ $data->team_id }}</td>
                  <td> <img src="uploads/team/{{ $data->picture }}" style="width: 100px; height: 70px; border-radius: 5px; object-fit: contain;"></td>
                  <td>
                    <a href="/our_team" target="_blank"><b>{{ $data->name }}</b></a><br>
          ...
          <td>
           ...
           <div class="btn-group" role="group">
            ...
            <a target="_blank" href="/edit_team/{{ $data->team_id }}" class="btn btn-info btn-xs" title="Edit"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
            <a onclick="return confirm('Are you sure to Delete?');" href="/delete_team/{{ $data->team_id }}" class="btn btn-danger btn-xs" title="Delete"><i class="fa fa-trash"></i></a>
          </div>
        </td>
      </tr>
@endforeach
              ...
              <div class="tab-pane" id="custom-tabs-four-profile" role="tabpanel" aria-labelledby="custom-tabs-four-profile-tab">
                @include('frontend.includes.success')
               <form name="CarFrom" action="/save_team" method="POST" enctype="multipart/form-data">   
         @csrf
         <div class="col-md-12">
          <div class="container-fluid">
           <div class="row">
