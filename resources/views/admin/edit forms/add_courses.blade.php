            ...
            <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
              <li class="nav-item">
                <a class="nav-link active" id="custom-tabs-four-home-tab" data-toggle="pill" href="#custom-tabs-four-home" role="tab" aria-controls="custom-tabs-four-home" aria-selected="true">
                  <i class="fa fa-list">&nbsp;&nbsp;</i>Courses Listing
                </a>
              </li>
              <li class="nav-item">
            ...
            <div class="tab-content" id="custom-tabs-four-tabContent">
              <div class="tab-pane fade show active" id="custom-tabs-four-home" role="tabpanel" aria-labelledby="custom-tabs-four-home-tab">
                ...
                <tbody>
                 ...
                 <tr>
                  <td></td>
                  <td> <img src="uploads/course/" style="width: 100px; height: 70px; border-radius: 5px; object-fit: contain;"></td>
                  <td>
                    <a href="/course_detail/" target="_blank"><b></b></a>
                  </td>
                  <td>
                   <b></b><br>
           ...
           <div class="btn-group" role="group">
            ...
            <a onclick="return confirm('Are you sure to Delete?');" href="" class="btn btn-danger btn-xs" title="Delete"><i class="fa fa-trash"></i></a>
              ...
              <div class="tab-pane" id="custom-tabs-four-profile" role="tabpanel" aria-labelledby="custom-tabs-four-profile-tab">
                @include('frontend.includes.success')
               <form name="CarFrom" action="/save_courses" method="POST" enctype="multipart/form-data">   
         @csrf
         <div class="col-md-12">
          <div class="container-fluid">
           <div class="row">
                 ...
                 <div class="card">
                   ...
                   <div class="row">
                    ...
                    <div class="col-md-6">
                     <div class="form-group">
                       ...
                       <input type="text" name="course" placeholder="Course Name" class="form-control" required>
                  ...
                  <div class="col-md-6">
                     <div class="form-group">
                       ...
                       <input type="text" name="fee" placeholder="Course Fee" class="form-control" required>
                       <p class="help-block text-danger">
                        @error('fee')
                        {{$message}}
                        @enderror
