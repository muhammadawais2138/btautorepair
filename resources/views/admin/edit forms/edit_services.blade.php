...
<div class="tab-pane fade show active" id="custom-tabs-four-profile" role="tabpanel" aria-labelledby="custom-tabs-four-profile-tab">
  @include('frontend.includes.success')
      ...
      <img src="/uploads/services/@php echo $service[0]['picture'] @endphp" style="width: 70px; height: 70px; border-radius: 5px;"></td>
         ...
         <textarea class="form-control" name="details" rows="4" placeholder="Details">@php echo $service[0]['details'] @endphp</textarea>
          <p class="help-block text-danger">
            @error('details')
            {{$message}}
            @enderror
...
<div class="col-md-12">
 <div class="card">
  ...
  <div class="col-md-12"> 
    <div class="card">
      <div class="col-md-12 bg-light"><label><i class="fa fa-home"></i>&nbsp;Additional Details</label></div> 
      <textarea type="text" rows="4" name="extra_detail" class="form-control textarea" id="" placeholder="Additional Detail About Services">@php echo $service[0]['extra_detail'] @endphp</textarea>
      <p class="help-block text-danger">
        @error('extra_detail')
        {{$message}}
        @enderror
