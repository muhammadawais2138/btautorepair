      ...
      <div class="col-md-12">
        <div class="card card-primary card-outline card-outline-tabs">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                     ...
                     <tr>
                      ...
                      <td> <img src="uploads/services/{{ $data->picture }}" style="width: 100px; height: 70px; border-radius: 5px; object-fit: contain;"></td>
                      <td>
                        <a href="/services/{{ $data->services_page_url }}" target="_blank"><b>{{ $data->services }}</b></a>
                      ...
                      <td>
                       ...
                       <div class="btn-group" role="group">
                        ...
                        <a target="_blank" href="/edit_services/{{ $data->service_id }}" class="btn btn-info btn-xs" title="Edit"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
                        <a onclick="return confirm('Are you sure to Delete?');" href="/delete_services/{{ $data->service_id }}" class="btn btn-danger btn-xs" title="Delete"><i class="fa fa-trash"></i></a>
                      </div>
                    </td>
                  </tr>
                  @endforeach
          ...
          <div class="tab-pane" id="custom-tabs-four-profile" role="tabpanel" aria-labelledby="custom-tabs-four-profile-tab">
            @include('frontend.includes.success')
            <form name="CarFrom" action="/save_services" method="POST" enctype="multipart/form-data">   
             @csrf
             <div class="col-md-12">
              <div class="container-fluid">
               <div class="row">
                ...
                <div class="col-md-12">
                  <div class="row">
                       ...
                       <div class="row">
                        ...
                        <div class="col-md-6">
                         <div class="form-group">
                           ...
                           <input type="text" name="services" placeholder="Service Name" class="form-control" required>
                    ...
                    <div class="col-md-12">
                     <div class="form-group">
                      <label for="exampleInputBorder">Details<code>*</code> <small>1000 characters maximum</small></label>
                      <textarea class="form-control" id="editor" name="details" rows="4" placeholder="Details"></textarea>
                      <p class="help-block text-danger">
                        @error('details')
                        {{$message}}
                        @enderror
