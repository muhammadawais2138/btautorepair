              ...
              <div class="tab-pane fade show active" id="custom-tabs-four-home" role="tabpanel" aria-labelledby="custom-tabs-four-home-tab">
                ...
                <tbody>
                 ...
                 <tr>
                  ...
                  <td> <img src="uploads/products/{{ $data->picture }}" style="width: 100px; height: 70px; border-radius: 5px; object-fit: contain;"></td>
                  <td>
                    <a href="/product_detail/{{ $data->products_page_url }}" target="_blank"><b>{{ $data->products }}</b></a>
                    <br>
                     Price : <b><sup>$</sup>{{ $data->price }}</b>
                  </td>
          <td>

           <div class="btn-group" role="group">
            <!-- <a href="" class="btn btn-warning btn-xs" title="View"> <i class="fa fa-eye"></i></a>&nbsp;&nbsp; -->
            <a target="_blank" href="/edit_products/{{ $data->product_id }}" class="btn btn-info btn-xs" title="Edit"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
            <a onclick="return confirm('Are you sure to Delete?');" href="/delete_products/{{ $data->product_id }}" class="btn btn-danger btn-xs" title="Delete"><i class="fa fa-trash"></i></a>
          </div>
        </td>
      </tr>
@endforeach
              ...
              <div class="tab-pane" id="custom-tabs-four-profile" role="tabpanel" aria-labelledby="custom-tabs-four-profile-tab">
                @include('frontend.includes.success')
               <form name="CarFrom" action="/save_products" method="POST" enctype="multipart/form-data">   
         @csrf
         <div class="col-md-12">
          <div class="container-fluid">
           <div class="row">
                   ...
                   <div class="row">
                    ...
                    <div class="col-md-6">
                     <div class="form-group">
                       ...
                       <input type="text" name="products" placeholder="Product Name" class="form-control" required>
